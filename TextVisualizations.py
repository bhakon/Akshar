...
def get_top_n_words_wo_stopwords(corpus, n_print=None):
    ...
    plt.title(label='Most Common Words (Unigrams)',
          ...
          pad='7.0')
    plt.tight_layout()
    mpld3.save_html(fig,"C:/Users/bhaskar/Desktop/FYP/new/static/unigram_wo_stopwords.html")
...
def get_top_n_words(corpus, n_print=None):
    ...
    plt.title(label='Most Common Words with stop words (Unigrams)',
          ...
          pad='7.0')
    plt.tight_layout()
    mpld3.save_html(fig,"C:/Users/bhaskar/Desktop/FYP/new/static/unigram_stopwords.html")
...
def get_top_n_bigram_stopwords(corpus, n_print=None):
    ...
    mpld3.save_html(fig ,"C:/Users/bhaskar/Desktop/FYP/new/static/bigram_stopwords.html")
...
def get_top_n_bigram_wo_stop_words(corpus, n_print=None):
    ...
    plt.title(label='Most Common Word Pair with out stop words (Bigrams)',
          ...
          pad='7.0')
    plt.tight_layout()
    mpld3.save_html(fig , "C:/Users/bhaskar/Desktop/FYP/new/static/bigram_wo_stopwords.html")
...
def get_top_n_trigram_stopwords(corpus, n_print=None):
    ...
    mpld3.save_html(fig,"C:/Users/bhaskar/Desktop/FYP/new/static/trigram_stopwords.html")
...
def get_top_n_trigram_wo_stop_words(corpus, n_print=None):
    ...
    plt.title(label='Most Common Word trio with out stop words (trigrams)',
          ...
          pad='7.0')
    plt.tight_layout()
    mpld3.save_html(fig,"C:/Users/bhaskar/Desktop/FYP/new/static/trigram_wo_stopwords.html")
...
def plot_pos(corpus):
    ...
    plt.title(label='Top 20 Part-of-speech tagging for given text',
          ...
          pad='7.0')
    plt.tight_layout()
    mpld3.save_html(fig,"C:/Users/bhaskar/Desktop/FYP/new/static/pos.html")
...
def generate_wordcloud(corpus):
    ...
    plt.axis("off")
    plt.tight_layout()
    plt.savefig("C:/Users/bhaskar/Desktop/FYP/new/static/wordcloud.jpg")
